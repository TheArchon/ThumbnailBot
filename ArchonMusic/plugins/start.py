...
async def start(_, message: types.Message):
    ...
    if private:
        ...
        # Log EVERY /start so the logger records who started the bot,
        # even when the user already exists in the database.
        try:
        ...
        # Database insert is still done only for new users.
